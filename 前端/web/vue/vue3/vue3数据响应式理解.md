...
![image-20201014155433311](http://mdrs.yuanjin.tech/img/20201014155433.png)
...
2. vue2的构造函数集成了太多功能，不利于tree shaking(树摇)，vue3把这些功能使用普通函数导出，能够充分利用tree shaking优化打包体积
...
- 什么是单向绑定
  - 数据驱动视图
    - ref和reactive返回的代理对象发生变化时，驱动template中的视图发生改变
- 双向绑定
  - 数据驱动视图
  - 视图驱动数据
    - 核心是input方法发生变化，触发值的修改
